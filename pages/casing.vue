<template>
      ...
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
        <div class="grid place-content-center rounded bg-gray-100 p-6 sm:p-8">
          <div class="mx-auto max-w-md text-center lg:text-left">
            <header>
              <h2 class="text-xl font-bold text-lima-500 sm:text-3xl">
                Casings
              </h2>
            ...
            <a
              href="#"
              class="mt-8 inline-block rounded border border-lima-900 bg-lima-600 px-12 py-3 text-sm font-medium text-white transition hover:shadow focus:outline-none focus:ring"
            >
              Shop All
            </a>
          </div>
  ...
  <section>
    <div
      class="mx-auto max-w-screen-xl px-4 py-8 shadow-lg sm:px-6 sm:py-12 lg:px-8"
    >
      ...
      <ul class="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <li>
          <a href="#" class="group relative block">
            ...
            >
              <h3 class="bg-black p-1 text-xl font-medium text-white">
                Casual Trainers
              </h3>
