...
<template>
  <footer class="body-font text-gray-600 dark:text-white">
    <div class="bg-gray-100 dark:bg-gray-800">
      <div
        class="container mx-auto flex flex-col items-center px-5 py-6 sm:flex-row"
      >
        <a
        ...
        >
          ...
          <a class="ml-3 text-gray-900 dark:text-white">
            <svg
              fill="currentColor"
              stroke-linecap="round"
              stroke-linejoin="round"
